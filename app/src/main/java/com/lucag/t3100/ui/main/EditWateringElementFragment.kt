...
import com.lucag.t3100.databinding.FragmentEditwateringelementBinding
...
class EditWateringElementFragment : Fragment(), TimePickerDialog.OnTimeSetListener {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            layoutInflater,
            R.layout.fragment_editwateringelement,
            container,
            false
        )
        ...
        args.wateringelementposition?.toIntOrNull()?.let { wateringElementPosition ->
            ...
            binding.tvWater.text =
                "Wassermenge ${((currentWateringElement.water) * (args.calibrationValue.toDouble())).toInt()} mL"
        ...
        binding.seekBarWater.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(p0: SeekBar?, p1: Int, p2: Boolean) {
                binding.tvWater.text = "Wassermenge ${p1 * 100} mL"
            }
